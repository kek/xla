...
//
//   ServiceExecutableRunOptions run_options;
//   BufferAllocations allocations({lhs, rhs, out}, 0,
//   executor->GetAllocator()); Thunk::ExecuteParams params(run_options,
//   allocations, &stream, {});
//
...
//   se::DeviceMemory<float> updated_out = executor->AllocateArray<float>(2 *
//   3); stream.ThenMemZero(&updated_out, out_length);
//
//   // Update buffer allocation to updated `out` buffer.
//   allocations =
//       BufferAllocations({lhs, rhs, updated_out}, 0,
